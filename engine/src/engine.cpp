...
public:
    void init(int x, int y, vector<float>& norm, float scale)
    {
        ...
        norm = math.matrix_multiplying(
            math.scaling_matrix(
                (float)height_in_pixels / (float)width_in_pixels, 1),
            math.scaling_matrix(scale, scale));
        ...
        morphing_program =
            set_program("res/shaders/morphing_vertex_shader.txt",
        ...
        set_texture("res/textures/explosion/01.png",
                    textures.at("explosion01"));
        set_texture("res/textures/explosion/02.png",
                    textures.at("explosion02"));
        set_texture("res/textures/explosion/03.png",
                    textures.at("explosion03"));
        set_texture("res/textures/explosion/04.png",
                    textures.at("explosion04"));
        set_texture("res/textures/explosion/05.png",
                    textures.at("explosion05"));
        set_texture("res/textures/explosion/06.png",
                    textures.at("explosion06"));
        set_texture("res/textures/explosion/07.png",
                    textures.at("explosion07"));
    ...
    bool read_events()
    {
        ...
        while (SDL_PollEvent(&Event))
        {
            ...
            if (Event.type == SDL_EVENT_FINGER_DOWN)
            {
                ...
                else if (Event.tfinger.x * width_in_pixels >
                             width_in_pixels * 0.8 &&
                         Event.tfinger.x * width_in_pixels <
    ...
    float check_button(string button)
    {
    ...
    unsigned int get_texture(string texture)
    {
                         ...
                         bool          blending)
    {
        ...
        glUniform4fv(glGetUniformLocation(main_program, "figure1_color"),
                     1,
                     obstacle_color.data());
                         ...
                         vector<float> shift_matrix)
    {
        ...
        glUniformMatrix3fv(
            glGetUniformLocation(morphing_program, "norm_matrix"),
            1,
            GL_TRUE,
            normolize_matrix.data());

        glUniformMatrix3fv(
            glGetUniformLocation(morphing_program, "shift_matrix"),
            1,
            GL_TRUE,
            shift_matrix.data());

        glUniform1f(glGetUniformLocation(morphing_program, "theta"),
                    sin(get_time() * 0.007));
        ...
        glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, 24, 0);
        check_gl_errors();
        glVertexAttribPointer(
                     ...
                     vector<unsigned int> ind)
    {
        ...
        check_gl_errors();
        glVertexAttribPointer(
            1, 3, GL_FLOAT, GL_FALSE, 24, attributes.data() + 3);
    ...
    void draw_widgets(bool& is_paused, int score)
    {
        ...
        ImGui::SetNextWindowPos(
            ImVec2(io.DisplaySize.x * 0.02f, io.DisplaySize.y * 0.02f));
        ...
        ImGui::SetNextWindowPos(
            ImVec2(io.DisplaySize.x * 0.79f, io.DisplaySize.y * 0.02f));
    ...
    {
        my_audio::sounds[num]->play_audio();
    }
    ...
    void stop_audio(int num)
    {
        my_audio::sounds[num]->stop_audio();
    }
...
private:
    ...
    unordered_map<string, float> buttons{
        { "A", 0 },       { "W", 0 },           { "S", 0 },
        { "D", 0 },       { "MOUSE_WHEEL", 0 }, { "MOUSE_CLICK", 0 },
        { "MOUSE_UP", 0 }
    };

    unordered_map<string, unsigned int> textures{
        { "explosion01", 0 }, { "explosion02", 0 }, { "explosion03", 0 },
        { "explosion04", 0 }, { "explosion05", 0 }, { "explosion06", 0 },
        { "explosion07", 0 }, { "tank_part_1", 0 }, { "tank_part_2", 0 },
        { "missile", 0 },     { "brick_wall", 0 },  { "broken_wall", 0 },
        { "stone_wall", 0 },  { "background", 0 },  { "arrow_up", 0 },
        { "arrow_down", 0 }
    };

    unordered_map<string, unsigned int> vertex_buffers{
        { "tank", 0 },    { "missile", 0 },    { "animation", 0 },
        { "object", 0 },  { "background", 0 }, { "arrow", 0 },
        { "figure1", 0 }, { "figure2", 0 }
    };
