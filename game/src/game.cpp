...
const vector<float> tank_vertecies = { -0.2f, 0.1f,  0.0f, 0.0f, 1.0f,
                                       0.2f,  0.1f,  0.0f, 0.0f, 0.0f,
                                       0.2f,  -0.1f, 0.0f, 1.0f, 0.0f,
                                       -0.2f, -0.1f, 0.0f, 1.0f, 1.0f };

const vector<float> missile_vertecies = { -0.041f, -0.022f, 1.0f, 1.0f, 1.0f,
                                          -0.041f, 0.022f,  1.0f, 0.0f, 1.0f,
                                          0.041f,  0.022f,  1.0f, 0.0f, 0.0f,
                                          0.041f,  -0.022f, 1.0f, 1.0f, 0.0f };

const vector<float> animation_vertecies = { -0.1f, 0.1f,  0.0f, 0.0f, 0.0f,
                                            0.1f,  0.1f,  0.0f, 1.0f, 0.0f,
                                            0.1f,  -0.1f, 0.0f, 1.0f, 1.0f,
                                            -0.1f, -0.1f, 0.0f, 0.0f, 1.0f };

const vector<float> obj_vertecies = { -0.1f, 0.1f,  0.0f, 0.0f, 0.0f,
                                      0.1f,  0.1f,  0.0f, 1.0f, 0.0f,
                                      0.1f,  -0.1f, 0.0f, 1.0f, 1.0f,
                                      -0.1f, -0.1f, 0.0f, 0.0f, 1.0f };

const vector<float> background_vertecies = { -1.0f, 1.0f,  0.0f, 0.0f, 0.0f,
...
int main(int argc, char* argv[])
{
    ...
    myeng->set_buffer(myeng->get_vertex_buffer("animation"),
                      animation_vertecies);
    myeng->set_buffer(myeng->get_vertex_buffer("object"), obj_vertecies);
    myeng->set_buffer(myeng->get_vertex_buffer("background"),
                      background_vertecies);
